      ...
      <div className={`${classes.contact__container} bg-gray-50`}>
        ...
        >
          ...
          <p className="text-gray-500 py-5 text-left text-lg">
            We&apos;d love to hear back from you and help you to generate the
            best content. Please get in touch with us by dropping an email or
        ...
        >
          <h1 className="font-medium text-2xl text-blue-800 mb-4">
            Contact Us
          </h1>
