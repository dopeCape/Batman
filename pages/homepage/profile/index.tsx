...
const Profile = () => {
    ...
    return <div className={`${theme ==="light" ? "bg-white" : "bg-dark"}  py-4 my-4 mx-auto w-11/12 md:w-9/12`} style={{height: "100%", borderTop: "2px solid #F0F0FA"}}>
        ...
        <div className="w-11/12  mt-10 mx-auto px-3 md:px-6 flex flex-col justify-center items-start md:flex-row md:justify-between md:items-center border-2 border-light-blue rounded-md" style={{height: "143px"}}>
            ...
            className="rounded-full mx-2  flex  px-4 py-2 items-center justify-center cursor-pointer bg-slate-300"
          >
