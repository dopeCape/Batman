    ...
    <div className="flex flex-col md:flex-row	justify-center items-center w-full h-full">
      <div className="w-full h-screen flex dark:bg-[#232529] bg-[#F2F2F2] px-10 py-16 flex-col">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="my-4">
          ...
          <h3 className=" text-lg my-3 font-medium dark:text-[#A7A7A7]">Keywords <span className='text-red-500'>*</span></h3>
          <div className="flex flex-row">
            <input
            ...
            <button
              onClick={addKeyword}
              className="cursor-pointer dark:bg-[#1B1D21] ms-2 bg-white w-1/5 flex justify-center items-center  rounded-lg"
            >
          ...
          <h3 className=" text-lg my-3 font-medium dark:text-[#A7A7A7]">Tone <span className='text-red-500'>*</span></h3>
          <Autocomplete
            value={value}
          ...
          <div className="relative">
            <h3 className=" text-lg my-3 font-medium dark:text-[#A7A7A7]">Target audience <span className='text-red-500'>*</span></h3>
            <input
              className="w-full px-2 py-2 rounded-lg  dark:bg-[#1B1D21] bg-[#FFFFFF]"
              type="text"
          ...
          <p className='font-bold mx-auto text-center'>20 tokens</p>
        </form>
      </div>
      <Modal
        open={open}
