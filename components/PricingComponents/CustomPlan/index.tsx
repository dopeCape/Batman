  ...
  return (
    <div className='flex flex-col w-[500px] py-0 items-center '>
      <div className='flex flex-col w-[100%] py-10 items-center '>
        ...
        <p className='w-[65%] text-[#838995] text-[20px] text-center font-medium'>Take your business to the next level with custom packages, custom AI model development, onboarding, and support.</p>
