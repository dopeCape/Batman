...
function FreeTrial() {
  return (
    <div className='flex flex-col w-[500px] items-center '>
      <div className='flex flex-col  w-[100%] py-10 items-center '>
        <h1 className='text-[#101827] font-bold text-3xl'>Free Trial</h1>
        <p className='font-medium py-2 text-[#4b5563] text-[23px] w-[60%] text-center '>Give Metridash a try for free</p>
        <p className='w-[65%] text-[#838995] text-[20px] text-center font-medium'>Free trial of Metridash features to help you get a taste of AI writing.</p>
        <div className='flex flex-col h-[450px] items-center'>
          ...
          <div className='flex items-center  gap-x-5 py-10'>
           ...
           <p className='text-[#101827] font-bold text-xl'>100 Tokens/month</p> <span className='text-[#4b5563] font-medium text-xl'>1 seat</span>
          </div>
          <div className='flex items-center  gap-x-5 mb-4'>
           ...
           <p className='text-[#101827] font-bold text-xl'>10,000 words/month</p> <span className='text-[#4b5563] font-medium text-xl'>1 seat</span>
          </div>
