...
import coins from "../../public/homepageIcons/Coins.png";
import content from "../../public/homepageIcons/content-creation.png";
import dashboard from "../../public/homepageIcons/dashboard.png";
import draft from "../../public/homepageIcons/draft.png";
import profile from "../../public/homepageIcons/profile-dropdown.png";
import schedule from "../../public/homepageIcons/schedule.png";
import user from "../../public/homepageIcons/user.png";
...
export default function LoginNavBar() {
  ...
  return (
    <div className='w-screen h-20 dark:bg-[#1B1D21] flex bg-[#fff] flex-row items-center justify-evenly'>
      <Link href="/homepage" className='font-bold text-3xl bg-gradient-to-r text-transparent from-[#00C5D7] to-[#0077BE] bg-clip-text'>Metridash</Link>
      <NavLink href="/homepage/contentCreation" src={content} alt="content"> 
        <p className='ms-1'>
          Content creation
        </p>
      </NavLink>
      <NavLink href="/homepage" src={dashboard} alt="dashboard">
        <p className='ms-1'>
          Dashboard
        </p>
      </NavLink>
      ...
      <span onClick={() => setTheme("light")}>Light</span> | {theme} */}
        ...
        <Link href="/pricing" className={`bg-blue rounded-md p-1 flex flex-row justify-between text-white`}>
