...
export default function LoginNavBar() {
  ...
  return (
    <div className='bg-dark'>
      <div className={`w-screen h-20 ${toggle ? "bg-dark text-white"  : "bg-white text-dark"} container px-10 font-sans  mx-auto flex flex-row items-center justify-between`}>
          ...
          <div
            ...
            className='w-1/4 items-center tracking-widest font-bold text-3xl mx-auto'>
            ...
            <div className='w-2/4 flex justify-between items-center'>
                ...
                <div>
                  <Link href="/homepage" className={`flex flex-row items-center ${toggle ? 'text-grey3' : 'text-grey6 font-medium'}`}>
                ...
                <div>
                  <Link href="/homepage/schedule" className={`flex flex-row items-center ${toggle ? 'text-grey3' : 'text-grey6 font-medium'}`}>
                ...
                <div>
                  <Link href="/homepage/drafts" className={`flex flex-row items-center ${toggle ? 'text-grey3' : 'text-grey6 font-medium'}`}>
            ...
            <div className='flex flex-row w-1/4 pt-2 justify-between items-center px-5'>    
              ...
              <div className='relative'>
                ...
                {showSettings && <div className={`absolute p-2 w-28 h-32 ${toggle ? "bg-grey" : " bg-grey2"}`}>
