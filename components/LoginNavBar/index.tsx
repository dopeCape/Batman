...
export default function LoginNavBar() {
  ...
  const NavLink = ({ href, src, alt, children }: any) => {
    ...
    return (
      ...
      <Link className={`flex flex-row items-center ${isActive ? 'h-full items-center flex text-center  dark:text-white border-b-4 dark:border-white border-[#3247CF] font-bold text-[#3247CF]' : 'dark:text-white text-[#3E4045] font-normal'
